...
public class SubjectCRUD {
    ...
    SubjectBusinessLogic serviceSubject = new SubjectBusinessLogic();
    GradeBusinessLogic serviceGrade = new GradeBusinessLogic();
    DataInput input = new DataInput(serviceGrade.getStorage(), serviceSubject.getStorage());
    CRUD turnBack = new CRUD();
